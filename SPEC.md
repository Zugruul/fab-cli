...
- I10: Doubts involving specific cards resolve by consulting the card sources for exact current text (third_party/flesh-and-blood-cards + Card Vault rulings), reviewing the relevant CR rules, and deriving the interaction from text + rules together — never from remembered card text.
