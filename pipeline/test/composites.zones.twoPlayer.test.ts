  ...
  it("near mat's cards are translated down by matHeight; far mat's cards are 180-rotated about the mat center, not translated in x", () => {
    const near = renderResult({
      label: {
        ...
        backgroundType: "external",
        backgroundHash: "hash123",
        cards: [{ printingId: "near-card", corners: [{ x: 1, y: 1 }, { x: 5, y: 1 }, { x: 5, y: 5 }, { x: 1, y: 5 }], tags: [], visibleFraction: 1 }],
        excludedCards: 0,
        cardBacksPlaced: 0,
      },
    });
    const far = renderResult({
      label: {
        ...
        backgroundType: "external",
        backgroundHash: "hash123",
        cards: [{ printingId: "far-card", corners: [{ x: 1, y: 1 }, { x: 5, y: 1 }, { x: 5, y: 5 }, { x: 1, y: 5 }], tags: [], visibleFraction: 1 }],
        excludedCards: 0,
        cardBacksPlaced: 0,
      },
    });
