...
Ruling: with New Horizon in play granting a second arsenal zone (conditional on already having a face-up arsenal card), reloading Bolt'n' Shot after it hits REQUIRES both arsenal zones to be empty (8.5.23a) — if either zone still holds a card (face-up or face-down), the reload effect simply fails; there's no partial reload or choice of which zone. This is a real cost to running New Horizon's extra-arsenal-zone effect alongside reload-matters cards: the second zone raises the bar for reload to fire at all.
