...
Hub for the JUDGE brain: adjudicating and running Flesh and Blood (FAB) tournaments. FAB ONLY — never import terms or policy from any other card game.

Document set (cite section + this version in every note):
- Tournament Rules and Policy (TRP), Penalty and Procedure Guide (PPG), Comprehensive Rules (CR): rules.fabtcg.com/txt/latest, all last-modified 2026-06-10.
- Flesh and Blood Casual Procedure Guide, dated 2023-10-13 (vendored PDF).

Cluster entry points:
- How the game is played: [[game-base-loop]] → [[combat-chain-steps]], [[priority-and-the-stack]].
- Rules adjudication (CR): [[layers-and-continuous-effect-staging]], [[replacement-effect-ordering]], [[triggered-effects-and-ordering]], [[game-state-actions-and-death]].
- Tournament structure (TRP): [[event-tiers-and-rels]], [[tournament-roles]], [[round-structure-and-timing]], [[official-formats]].
- Gameplay logistics (TRP): [[game-information-categories]], [[shortcuts-and-out-of-order-play]], [[note-taking-rules]].
