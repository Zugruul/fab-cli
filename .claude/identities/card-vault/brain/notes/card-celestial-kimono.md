---
tags: [card, celestial-kimono, celestial, kimono, illusionist, equipment, chest, ward-1, dyn213]
paths: []
strength: 1
source: "third_party/flesh-and-blood-cards json/english/card.json (uid BJtgTRQQmrbDwrGQMmqm6) · https://cardvault.fabtcg.com/"
graduated: false
created: 2026-07-10
entities: [card:celestial-kimono]
name: "Celestial Kimono"
classes: [Illusionist]
types: [Equipment]
subtypes: [Chest]
keywords: [Ward 1]
unique-id: BJtgTRQQmrbDwrGQMmqm6
sets: [DYN]
codes: [DYN213]
---

**Celestial Kimono** — Illusionist Equipment - Chest

"Once per turn, when Celestial Kimono or a non-token permanent you control with ward is destroyed, gain {r}.
Ward 1"
