---
tags: [card, run-into-trouble, run, into, trouble, brute, warrior, block, pitch-1, hvy161, kyo015, lgs251]
paths: []
strength: 1
source: "third_party/flesh-and-blood-cards json/english/card.json (uid wbJtMrPCzqL6NRGrT6fJK) · https://cardvault.fabtcg.com/"
graduated: false
created: 2026-07-10
entities: [card:run-into-trouble]
name: "Run into Trouble"
full-name: "Run into Trouble (red)"
color: red
pitch: 1
defense: 3
classes: [Brute, Warrior]
types: [Block]
unique-id: wbJtMrPCzqL6NRGrT6fJK
sets: [HVY, KYO, LGS]
codes: [HVY161, KYO015, LGS251]
---

**Run into Trouble (red)** — Brute / Warrior Block · 3 defense
