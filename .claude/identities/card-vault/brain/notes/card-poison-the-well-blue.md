---
tags: [card, poison-the-well, poison, well, generic, instant, pitch-3, cost-0, dtd231, jdg035]
paths: []
strength: 1
source: "third_party/flesh-and-blood-cards json/english/card.json (uid BqMDcNR8b6m7L7QPtHgTB) · https://cardvault.fabtcg.com/"
graduated: false
created: 2026-07-10
entities: [card:poison-the-well]
name: "Poison the Well"
full-name: "Poison the Well (blue)"
color: blue
pitch: 3
cost: 0
classes: [Generic]
types: [Instant]
unique-id: BqMDcNR8b6m7L7QPtHgTB
sets: [DTD, JDG]
codes: [DTD231, JDG035]
---

**Poison the Well (blue)** — Generic Instant · cost 0
