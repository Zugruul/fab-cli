---
tags: [card, dissipation-shield, dissipation, shield, mechanologist, action, item, pitch-2, cost-2, 1hp217, arc035]
paths: []
strength: 1
source: "third_party/flesh-and-blood-cards json/english/card.json (uid HGhtMHhF6dqdNccmNK7w8) · https://cardvault.fabtcg.com/"
graduated: false
created: 2026-07-10
entities: [card:dissipation-shield]
name: "Dissipation Shield"
full-name: "Dissipation Shield (yellow)"
color: yellow
pitch: 2
cost: 2
...
types: [Action]
subtypes: [Item]
unique-id: HGhtMHhF6dqdNccmNK7w8
sets: [1HP, ARC]
codes: [1HP217, ARC035]
---

**Dissipation Shield (yellow)** — Mechanologist Action - Item · cost 2

"Dissipation Shield enters the arena with 4 steam counters on it.
