---
tags: [card, gone-in-a-flash, gone, flash, lightning, action, attack, pitch-1, cost-0, ros076]
paths: []
strength: 1
source: "third_party/flesh-and-blood-cards json/english/card.json (uid DHfcJWbWWPdKWcGdtWmnQ) · https://cardvault.fabtcg.com/"
graduated: false
created: 2026-07-10
entities: [card:gone-in-a-flash]
name: "Gone in a Flash"
full-name: "Gone in a Flash (red)"
color: red
pitch: 1
cost: 0
power: 4
...
types: [Action]
subtypes: [Attack]
unique-id: DHfcJWbWWPdKWcGdtWmnQ
sets: [ROS]
codes: [ROS076]
---

**Gone in a Flash (red)** — Lightning Action - Attack · cost 0 · 4 power · 3 defense
