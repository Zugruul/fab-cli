...
Index for the PLAYER brain — how to play Flesh and Blood well. FAB ONLY; every game fact is cited (CR section, learn-to-play transcript, card DB, or fabtcg.com); card legality is never memorized ([[card-legality-pointer]]).

Base gameplay loop: [[objective-and-life]], [[intellect-and-hand-refill]], [[first-turn-rule]], [[turn-structure-phases]], [[action-points-and-go-again]], [[resource-cost-and-pitching]], [[pitch-values-and-color]], [[arsenal]], [[weapon-attacks]].

Combat: [[combat-chain-and-chain-links]], [[chain-link-steps]], [[defending-from-hand]], [[attack-and-defense-reactions]], [[hit-determination-and-damage]], [[chain-closing]].

Strategic fundamentals: [[hand-value-card-advantage]], [[pitch-curve-planning]], [[block-vs-take-tradeoff]], [[tempo-and-go-again-chains]], [[arsenal-as-tempo-setup]], [[second-cycle-awareness]].

Formats: [[format-classic-constructed]], [[format-silver-age]], [[format-blitz]], [[format-living-legend]], [[living-legend-rotation-system]], [[format-limited-draft-sealed]], [[format-ultimate-pit-fight]], [[card-legality-pointer]].
